							...
							<div class="col-12">
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										...
										<a href="https://wa.me/51943406540/?text=Estoy%20interesado%20en%20este%20producto%0A*{{$product_detail->title}}*%0A{{route('product-detail',$product_detail->slug)}}" class="whatsapp" target="_blank"> <i class="fa fa-whatsapp whatsapp-icon"> Me interesa</i></a>
									</div>
